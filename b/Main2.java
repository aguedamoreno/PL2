...
public class Main2 {
    ...
    public static void main(String[] args) {
        String rutaArchivo = "src/esc/uah/matcomp/PL2/B/fichero.json";

        // Llamamos al metodo usando el nombre de la otra clase delante
        ...
        if (usuarioCargado != null) {
            ...
            System.out.println("Error: No se encuentra el archivo 'usuario.json'");
        }
    }
